...
class KvadruplaController {
    ...
    public function load($view, $data = []){    //a view meghatározza mi szerint kérdezünk le.
        ...
        include("../view/Kvadrupla/{$view}.php");  //Betöltjük azt a műveletnek megfelelő nézetet (oldalt), amivel hívtuk. Dupla aposzrófnál a PHP tudja értelmezni, hogy középen változó van.
